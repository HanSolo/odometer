...
public class ImageSpinner extends Region implements Spinner {
    ...
    private        final SpinnerEvent                                           VALUE_CHANGED_EVENT = new SpinnerEvent(ImageSpinner.this, EventType.VALUE_CHANGED);
    private        final SpinnerEvent                                           ZERO_PASSED_EVENT   = new SpinnerEvent(ImageSpinner.this, EventType.ZERO_PASSED);
